...
const INITIAL_MESSAGES: ChatMessage[] = [
  {
    id: 'msg-1',
    sender: 'assistant',
    text: "Hello! I am your Nyoria Dermatology Assistant powered by the Nyoria Engine. How can I assist with your cellular score or Nepalese pharmacy formulations today?",
    timestamp: 'Just now',
    quickPrompts: [
      'Can I mix Niacinamide with Vitamin C?',
      'How to treat enlarged pores?',
      'Explain my Nyoria Cellular Health Index'
    ]
  }
];

export const NyoriaAssistantPanel: React.FC = () => {
  ...
  const handleSendMessage = (textToSend?: string) => {
    ...
    setTimeout(() => {
      let replyText = "Based on your Nyoria Diagnostic Protocol metrics, we recommend maintaining lipid barrier hydration while incorporating gentle BHA micro-exfoliation.";
      ...
      if (lower.includes('niacinamide') || lower.includes('vitamin c')) {
        ...
        replyText = "Enlarged pores and nasal comedones respond best to 2% Encapsulated Salicylic Acid (e.g. Cipla Saslic DS) and 0.3% Retinol at night to clear sebum plugs and boost follicular collagen support.";
      } else if (lower.includes('score') || lower.includes('84')) {
        replyText = "Your 84/100 Nyoria Cellular Health Index indicates high overall epidermal clarity! Your T-Zone oiliness (72/100) is your primary focus area for balancing.";
      }
      ...
      const botMsg: ChatMessage = {
        ...
        text: replyText,
        timestamp: 'Just now',
        quickPrompts: ['Which Nepali products match my score?', 'How to soothe redness?']
      };
          ...
          >
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="font-heading font-extrabold text-sm text-[var(--text-primary)]">
                    Nyoria Dermatology Assistant
                  </h4>
                  <div className="flex items-center gap-1.5 text-[10px] text-emerald-400 font-semibold">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                    <span>Powered by Nyoria Engine</span>
                  </div>
                </div>
              </div>
            ...
            <div className="p-3 bg-[var(--bg-secondary)] border-t border-[var(--border-color)] flex items-center gap-2">
              <input
                ...
                placeholder="Ask Nyoria Assistant about formulations..."
