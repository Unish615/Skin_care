...
import { LineChart as ChartIcon, Sparkles, SlidersHorizontal, ArrowUpRight, TrendingUp } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-[var(--text-primary)] tracking-tight">
            "My Skin Journey" <span className="glow-text-purple">Dashboard</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Recharts Score Trajectory (7 cols) */}
          <div className="lg:col-span-7 glass-card p-8 border border-[var(--border-glass)] shadow-2xl flex flex-col justify-between">
              ...
              <div className="h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={MOCK_JOURNEY_DATA}>
                    ...
                    />
                    <Line type="monotone" dataKey="score" name="Overall Health" stroke="#7C3AED" strokeWidth={3} dot={{ r: 6, fill: '#7C3AED' }} />
            ...
            <div className="pt-4 border-t border-[var(--border-color)] flex flex-wrap gap-4 text-xs font-semibold">
              <span className="flex items-center gap-1.5 text-[var(--text-primary)]">
                <span className="w-3 h-3 rounded-full bg-[#7C3AED]" /> Overall Health
              </span>
              <span className="flex items-center gap-1.5 text-[var(--text-primary)]">
          ...
          <div className="lg:col-span-5 glass-card p-6 border border-[var(--border-glass)] shadow-2xl flex flex-col justify-between">
            <div>
              ...
              >
                ...
                {/* Vertical Divider */}
                <div className="absolute top-0 bottom-0 w-1 bg-white shadow-[0_0_15px_#7C3AED]" style={{ left: `${sliderPosition}%` }}>
                  <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-white text-purple-600 shadow-xl flex items-center justify-center">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
              ...
              <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20">
                <span className="text-emerald-500 block text-[10px]">Month 3 Result</span>
                <span className="font-heading font-extrabold text-sm text-emerald-500">T-Zone Sebum: 62 ✓</span>
              </div>
            </div>
